...
usage() {
    ...
    Commands:
      ...
      dev
        ...
        dev:test, test-dev                      Execute test of Dev env
        dev:test-front, test-front-dev          Execute test of Frontend Dev env
        dev:test-back, test-back-dev            Execute test of Backend Dev env
